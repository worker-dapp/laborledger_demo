      ...
      <div className='w-1/2 mx-auto pt-10'>
        ...
        <div className="space-y-4">
          {filteredDisputes.map((dispute) => (
            <div key={dispute.id} className="p-5 rounded-2xl shadow-2xl border border-gray-100 bg-white/80 backdrop-blur-lg">
              <h3 className="text-xl font-semibold">Dispute ID: {dispute.id}</h3>
